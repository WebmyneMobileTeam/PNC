 ...
 */
public class NutritionCalculationSingleRecipe {

    private Context _context;
    private ArrayList<recipeIngredient> recipesIng;
    ...
    public NutritionCalculationSingleRecipe(Context _context, ArrayList<recipeIngredient> recipeing, glossaryDescription ingredients_values) {
    ...
    private void calculate( ) {
        ...
        try {
            ...
            for (recipeIngredient ingredient : recipesIng) {

                String cuurentRecipeIngredientID = ingredient.ingredient_id;
