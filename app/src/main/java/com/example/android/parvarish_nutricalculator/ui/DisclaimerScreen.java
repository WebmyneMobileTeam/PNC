...
//            toolbar.setLogo(R.drawable.logo);
    ...
    private void openSettings() {
        ...
        popupWindow1 = new ListPopupWindow(DisclaimerScreen.this);
        ...
        popupWindow1.setAdapter(new SettingsAdapter(DisclaimerScreen.this, arrayList, drawableImage,true));
        popupWindow1.show();
    }
    ...
    private void openMore() {
        ...
        int[] drawableImage = {R.drawable.icon_home, R.drawable.drawable_profile, R.drawable.drawable_myrecipes, R.drawable.drawable_diary, R.drawable.drawable_friends, R.drawable.icon_nutritional, R.drawable.icon_gloassary, R.drawable.drawable_tour};
        popupWindow2 = new ListPopupWindow(DisclaimerScreen.this);
        ...
        popupWindow2.setAdapter(new MoreAdapter(DisclaimerScreen.this, arrayList, drawableImage, false));
        popupWindow2.show();
    ...
    private void logoutFromApp() {
        ...
        Log.e("click", "logout");
        PrefUtils.clearCurrentUser(DisclaimerScreen.this);
        ...
        ComplexPreferences complexPreferences = ComplexPreferences.getComplexPreferences(DisclaimerScreen.this, "user_pref", 0);
        complexPreferences.clearObject();
        complexPreferences.commit();
        Intent i = new Intent(DisclaimerScreen.this, StartScreen.class);
        startActivity(i);
        finish();
    }
                ...
                public void onClick(View v) {
                    ...
                    switch (position) {
                        case 4:
                            ...
                            Intent i = new Intent(DisclaimerScreen.this, DisclaimerScreen.class);
                            startActivity(i);
                            break;
                        case 5:
                            popupWindow1.dismiss();
                            Intent i2 = new Intent(DisclaimerScreen.this, AboutusScreen.class);
                            startActivity(i2);
                            break;
                        case 7:
                            popupWindow1.dismiss();
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    switch (position) {
                        ...
                        case 6:
                            popupWindow2.dismiss();
                            Intent i = new Intent(DisclaimerScreen.this, GlossaryScreenTemp.class);
                            startActivity(i);
                            break;
                        case 7:
                            Intent intent = new Intent(DisclaimerScreen.this, WalkThorugh.class);
